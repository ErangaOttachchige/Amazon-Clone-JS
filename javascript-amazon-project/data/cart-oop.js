...
// Btw in OOP, a naming convention is to, use PascalCase for things that create/generate objects
...
function Cart(localStorageKey) {
  ...
  return cart;     // from this we can use it outside the function
}
...
// now these 2 carts will load from different keys in localStorage and they can have different data
