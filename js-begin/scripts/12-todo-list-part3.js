...
function renderTodoList() {
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Practical example using .forEach()
    // Switch to .forEach()

    todoList.forEach((todoObject, index) => { // inside the brackets in the .forEach() method, we'll give it a function that we want to run for each todo , this function can have 2 parameters. The first parameter contains each value in the array, So we call it 'todoObject' and the second parameter contains each index in the array, So we call it 'index'

    // And now inside this loop, we basically wanna do everything that we did below 
  ...
  document.querySelector('.js-todo-list')
    ...
    // We put the HTML that we generated on to the page by above code line 
    // and So in order to add an EventListener, we need to put the HTML on the page first, SO we hcan now add an EventListener after the above code line

    // .querySelectorAll --> Will give us all the elements that have that class
    
    console.log(document.querySelectorAll('.js-delete-todo-button'));

    document.querySelectorAll('.js-delete-todo-button')
      .forEach((deletebutton /* <-- 1. the value */, index  /* <-- 2, the index */) => {
